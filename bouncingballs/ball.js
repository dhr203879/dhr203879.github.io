...
function Initialize(containerId) {
    ...
    balls.push(new Ball(svg, 600, 10, 'n1', 'red', Math.PI / 6));
    balls.push(new Ball(svg, 600, 50, 'n2', 'green', Math.PI / 6));
    balls.push(new Ball(svg, 600, 100, 'n3', 'yellow', Math.PI / 6));
    balls.push(new Ball(svg, 600, 150, 'n4', 'orange', Math.PI / 6));
    balls.push(new Ball(svg, 600, 200, 'n5', 'pink', Math.PI + Math.PI / 6));
    balls.push(new Ball(svg, 600, 250, 'n6', 'blue', Math.PI + Math.PI /6));
    balls.push(new Ball(svg, 600, 300, 'n7', 'aqua', Math.PI + Math.PI / 6));
    balls.push(new Ball(svg, 600, 400, 'n8', 'brown', Math.PI + Math.PI / 6));
    balls.push(new Ball(svg, 600, 500, 'n9', 'purple', Math.PI + Math.PI / 6));
    balls.push(new Ball(svg, 600, 600, 'n10', 'black', Math.PI + Math.PI / 6));
